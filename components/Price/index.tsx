...
export default function Price(props: Props) {
  ...
  const options = [
    {label: 'Выезд в дневное время', price: '1500 руб.'}, {label: 'Выезд в ночное время', price: '2500 руб.'}, 
    {label: 'Ремонт прокола', price: 'от 1500 руб.'}, {label: 'Ремонт пореза', price: 'от 1 800 руб.'},
    {label: 'Замена шин', price: 'от 2 000 руб.'}, {label: 'Выезд за МКАД', price: 'от 1500 руб + 20 руб. за 1км'},
  ]
