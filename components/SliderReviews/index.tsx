...
export default function SliderReviews(props: Props) {
  ...
  {avatar: null, name: 'Дарья Донцова', rating: 5, 
  text: 'Ночью на трассе спустило колесо, приехали быстро, оперативно нашли проблему! Отличные ребята, поддержали и успокоили) поехала дальше! Супер приложение, самое то для девушек за рулем! Быстро и безопасно! Удачи на дорогах!'
  },
  ]
